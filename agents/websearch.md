...
5. You MUST search until you find the answer - skipping search when the solution is unknown is FORBIDDEN.
6. Never attempt to answer without searching if there is any uncertainty.
